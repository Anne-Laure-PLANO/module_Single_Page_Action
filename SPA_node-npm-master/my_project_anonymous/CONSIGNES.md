...
2. Installer les modules NPM `imagemin@8.0.1` et `imagemin-pngquant` :

`npm install imagemin@8.0.1 imagemin-pngquant`

Que signifie le "@8.0.1" ?

`-> les chiffres après le @ correspondent à la version du package  à installer. Si la version ne correspond pas à notre code, il risque de casser. En précisant ainsi lors de l'installation, on évite ce risque.`
